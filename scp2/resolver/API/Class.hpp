...
namespace IL2CPP
{
    ...
    public:
        ...
        Unity::Color GetPropertyValue(const char* m_pPropertyName)
        {
            ...
            if (pProperty && pProperty->m_pGet)
                return reinterpret_cast<Unity::Color(UNITY_CALLING_CONVENTION)(void*)>(pProperty->m_pGet->m_pMethodPointer)(this);

            Unity::Color tDefault;
            return tDefault;
        }
